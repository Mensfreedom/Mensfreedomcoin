...
// The min. transaction fee (0.1 MFC) if required
static const int64 MIN_TX_FEE = 10000000;
// Fees below this value (0.05 MFC) are considered absent while relaying
static const int64 MIN_RELAY_TX_FEE = 5000000;
// The dust threshold (0.01 MFC)
static const int64 TX_DUST = 1000000;
// The max. amount for a single transaction;
// set to ~10% of the total coin supply in our case (10 million MFC)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // Mensfreedomcoin: 960 blocks per day target, priority boundary is 1 MFC day / 250 bytes
