...
const string strMessageMagic = "Mensfreedomcoin Signed Message:\n";
...
int64 GetBlockValue(int nHeight, int64 nFees) {
    ...
    // 25 MFC per block between the 3rd and 4th hard fork
    // 25 MFC per block before the 1st testnet hard fork
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal Mensfreedomcoin miner
...
//    bool fEnforceBIP30 = (pindex->nTime > nBIP30SwitchTime);
    /* always active for Mensfreedomcoin */
...
bool ProcessBlock(CNode* pfrom, CBlock* pblock)
{
    ...
    if (pcheckpoint && pblock->hashPrevBlock != hashBestChain)
    {
        ...
        // across the hard forks for Mensfreedomcoin in particular
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Mensfreedomcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew) {
    ...
    if(fTestNet) {
        ...
        hashGenesisBlock = uint256("0xf8ac0e6d564000cd3fec23a8ada0b00ba4c1471766bcdbceb200051a77b5aeb0");
    ...
    if(mapBlockIndex.empty()) {
        ...
        if(!fTestNet) {
            ...
            // The Mensfreedomcoin genesis block:
            ...
            const char* pszTimestamp = "Vladimir Putin had a telephone conversation with Angela - eng.news.kremlin.ru/news/22782 - August 6 2014";
            txNew.vin.resize(1);
            txNew.vout.resize(1);
            ...
            // The Mensfreedomcoin testnet genesis block:
            ...
            block.hashMerkleRoot = block.BuildMerkleTree();
            block.nVersion = 1;
            block.nTime    = 1407355200;
            block.nBits    = 0x1e0ffff0;
            block.nNonce   = 1129525;
        ...
        if(!fTestNet) assert(block.hashMerkleRoot == uint256("0x830d75171aa3704b9b09f3c95631f4d580cced24dec6aaa22a7508cf2b4fc123"));
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "version")
    {
        ...
        // Do not connect to these clients as they're not Mensfreedomcoin ones or too old
...
CBlock* CreateNewBlock(CReserveKey& reservekey) {
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // Mensfreedomcoin: low priority transactions up to 500 bytes in size
